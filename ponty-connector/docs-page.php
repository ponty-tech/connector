...
<h4><code>[pnty_jobs_table] <?php _e(
    "or",
    "pnty"
); ?> [pnty_showcase_table]</code></h4>
<table class="wp-list-table widefat">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php _e(
                "Shows the publish date as a table column.",
                "pnty"
            ); ?></td>
        </tr>
        <tr>
            ...
            <td><?php _e(
                "Shows the organization name as a table column.",
                "pnty"
            ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php _e(
                "Shows the location as a table column.",
                "pnty"
            ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php _e(
                "Make all table cell data linked.",
                "pnty"
            ); ?> (<?php _e("Only for active ads", "pnty"); ?>)</td>
        </tr>
        <tr>
            <td>tag</td>
            <td></td>
            ...
            <td><?php _e(
                "Only show items that has this tag (slug). Separate with pipe sign(|).",
                "pnty"
            ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php _e(
                "Adds the excerpt as a title attribute to all &lt;tr&gt; tags.",
                "pnty"
            ); ?></td>
        </tr>
    </tbody>
</table>
<h4><code>[pnty_jobs_list] <?php _e(
    "or",
    "pnty"
); ?> [pnty_showcase_list]</code></h4>
<table class="wp-list-table widefat">
    <thead>
        <tr>
            <th><?php _e("Attribute", "pnty"); ?></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php _e(
                "Show excerpt as part of the &lt;li&gt; tag.",
                "pnty"
            ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php _e(
                "Adds a read more link with attribute value as text.",
                "pnty"
            ); ?> (<?php _e("Only for active ads", "pnty"); ?>)</td>
        </tr>
        <tr>
